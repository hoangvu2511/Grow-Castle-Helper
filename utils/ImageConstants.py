...
class ImageConstants(SingletonImplement):
    def __init__(self):
        ...
        self.MIMIC_IMAGE: str = self._BASE_PATH + "mimic.png"

        self.ICON_CLOSE: str = self._BASE_PATH + "ic_close.png"

        self.TOWER_CLICKABLE: str = self._BASE_PATH + "max_dimond_use_case2.png"
        self.MAX_DIMOND_CONDITION: str = self._BASE_PATH + "max_dimond_use_case1.png"
        self.MAX_DIMOND_TARGET: str = self._BASE_PATH + "max_dimond_use_case3.png"
        self.MAX_DIMOND_LEVEL_UP: str = self._BASE_PATH + "max_dimond_use_case4.png"

        self.ICON_APP: str = self._BASE_PATH + "ic_app.png"
        self.ICON_APP_2: str = self._BASE_PATH + "ic_app2.png"

        self.DUNGEON_BASE: str = self._BASE_PATH + "dungeon/"
        self.DUNGEON_ENTRY: str = f"{self.DUNGEON_BASE}dungeon_entry.png"

    def dungeonRelated(self) -> dict[str, str]:
